...
// ✅ ເພີ່ມ remark ໃນ INSERT
$sql="INSERT INTO `$table`(full_name,account_type,account_status,primary_email,password,second_email,third_email,department,team,phone,ins_number,halo_device_number,remark)
      VALUES('$full_name','$email_type','$status','$primary_email','$password','$second_email','$third_email','$department','$team','$phone','$ins_number','$halo_device','$remark')";
