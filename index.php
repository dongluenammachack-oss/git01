...
<span>ICT Management â€” HALO Trust Laos</span>
</div>
...
<?php if($current_page=='dashboard'): ?>
    ...
    <div><h2>System Dashboard</h2><p>ICT Management Overview â€” Halo Trust Laos</p></div>
                                                            ...
                                                            <?php if($result&&mysqli_num_rows($result)>0):while($row=mysqli_fetch_assoc($result)): ?>
                                                                ...
                                                                <?php endwhile;else: ?>
                                                                    ...
                                                                    elseif($current_page=='device'&&$action=='transfer'): ?>
                                                                        ...
                                                                        <div class="form-section">
                                                                        <div class="form-section-hdr"><div class="step-badge" style="background:#dbeafe;color:#1d4ed8;">1</div><p>Device Identity â€” Enter Halo ID to auto-fill</p></div>
                                                                        <div class="form-grid g3">
                                                                        ...
                                                                        <div class="form-section">
                                                                        <div class="form-section-hdr"><div class="step-badge" style="background:#fee2e2;color:#b91c1c;">2</div><p>Transfer From â€” Current Owner (Auto-filled)</p></div>
                                                                        <div class="form-grid g3">
                                                                        ...
                                                                        <div class="form-section">
                                                                        <div class="form-section-hdr"><div class="step-badge" style="background:#dcfce7;color:#15803d;">3</div><p>Transfer To â€” New Owner &nbsp;<span style="font-size:.62rem;font-weight:600;color:var(--muted);text-transform:none;letter-spacing:0;">(Enter INS to auto-fill)</span></p></div>
                                                                        <div class="form-grid g3">
                                                                                            ...
                                                                                            elseif($current_page=='mistake'&&$action=='form'):
                                                                                                ...
                                                                                                <?php if($m_is_edit): ?><input type="hidden" name="mistake_id" value="<?=$m_edit['id']?>"><?php endif; ?>
                                                                                                    ...
                                                                                                    elseif($current_page=='mistake'&&$action=='list'):
                                                                                                        ...
                                                                                                        <select name="problem" class="filter-select"><option value="">All Problems</option><?php foreach(["Used as hotspot","Watching YouTube","Watching movies","Cracked casing","Cracked screen","Minor crack","Battery drains fast","Slow performance","Very slow","Cannot use","Charging port issue","Login form issue","Screen malfunction"] as $pc) echo "<option value='$pc' ".($filter_problem==$pc?'selected':'').">$pc</option>"; ?></select>
                                                                                                                                                            ...
                                                                                                                                                            <?php if($e_res&&mysqli_num_rows($e_res)>0):$eno=1;while($row=mysqli_fetch_assoc($e_res)): ?>
                                                                                                                                                                ...
                                                                                                                                                                <?php endwhile;else: ?><tr class="empty-row"><td colspan="8"><i class="fas fa-users"></i>No employees found</td></tr><?php endif; ?>
                                                                                                                                                                    ...
                                                                                                                                                                    elseif($current_page=='internet'&&$action=='form'):
                                                                                                                                                                        ...
                                                                                                                                                                        <div><h3><?=$inet_is_edit?'Edit Internet Record':'Add New Internet'?></h3><p>Record internet contract details: package, price and documents</p></div>
                                                                                                                                                                        </div>
                                                                                                                                                                        <div class="form-body">
                                                                                                                                                                        <form id="internetForm" action="save_internet.php" method="POST" enctype="multipart/form-data">
                                                                                                                                                                        <?php if($inet_is_edit): ?><input type="hidden" name="internet_id" value="<?=$inet_edit['id']?>"><?php endif; ?>
                                                                                                                                                                            
                                                                                                                                                                            <div class="form-section">
                                                                                                                                                                            <div class="form-section-hdr"><div class="step-badge" style="background:#ccfbf1;color:#0f766e;">1</div><p>Internet &amp; Provider Details</p></div>
                                                                                                                                                                            <div class="form-grid g3">
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Internet Local <span>*</span></label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-map-marker-alt fi"></i>
                                                                                                                                                                            <input type="text" name="internet_local" class="field" placeholder="e.g. Vientiane Office, Pakse Base" value="<?=htmlspecialchars($inet_edit['internet_local']??'')?>" required>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Internet Type <span>*</span></label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-network-wired fi"></i>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-box-open fi"></i>
                                                                                                                                                                            <input type="text" name="package" class="field" placeholder="e.g. Business 100Mbps, Unlimited" value="<?=htmlspecialchars($inet_edit['package']??'')?>">
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="form-section">
                                                                                                                                                                            <div class="form-section-hdr"><div class="step-badge" style="background:#dbeafe;color:#1d4ed8;">2</div><p>Pricing &amp; Contract Period</p></div>
                                                                                                                                                                            <div class="form-grid g4">
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Price (LAK) <span>*</span></label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-money-bill-wave fi"></i>
                                                                                                                                                                            <input type="number" name="price" class="field" placeholder="0" min="0" step="1000" value="<?=htmlspecialchars($inet_edit['price']??'0')?>" required>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Start Date <span>*</span></label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-calendar-plus fi"></i>
                                                                                                                                                                            <input type="date" name="start_date" class="field" value="<?=htmlspecialchars($inet_edit['start_date']??'')?>" required>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">End Date</label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-calendar-minus fi"></i>
                                                                                                                                                                            <input type="date" name="end_date" class="field" id="inet_end_date" value="<?=htmlspecialchars($inet_edit['end_date']??'')?>">
                                                                                                                                                                            </div>
                                                                                                                                                                            ...
                                                                                                                                                                            <i class="fas fa-clock" style="font-size:.7rem;"></i><span id="days-remaining-val">â€”</span>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="form-section">
                                                                                                                                                                            <div class="form-section-hdr"><div class="step-badge" style="background:#dcfce7;color:#15803d;">3</div><p>Document &amp; Reference</p></div>
                                                                                                                                                                            <div class="form-grid g2">
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Document Local <span style="font-size:.6rem;font-weight:500;color:var(--muted);">(Browse file from device)</span></label>
                                                                                                                                                                            <!-- Hidden real file input -->
                                                                                                                                                                            <input type="file" id="doc_file_input" name="doc_file" accept=".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg,.zip"
                                                                                                                                                                            ...
                                                                                                                                                                            onmouseover="this.style.background='var(--navy)'" onmouseout="this.style.background='var(--blue)'">
                                                                                                                                                                            ...
                                                                                                                                                                            <span id="doc_file_name">â€”</span>
                                                                                                                                                                            <span id="doc_file_size" style="color:var(--muted);font-weight:400;"></span>
                                                                                                                                                                            <button type="button" onclick="clearDocFile()" style="margin-left:auto;background:none;border:none;color:#b91c1c;cursor:pointer;font-size:.72rem;"><i class="fas fa-times"></i></button>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div>
                                                                                                                                                                            <label class="field-lbl">Document Link <span style="font-size:.6rem;font-weight:500;color:var(--muted);">(URL / Google Drive / Auto-filled after Browse)</span></label>
                                                                                                                                                                            <div class="field-wrap"><i class="fas fa-link fi"></i>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="form-section">
                                                                                                                                                                            <div class="form-section-hdr"><div class="step-badge" style="background:#f5f3ff;color:#7c3aed;">4</div><p>Additional Notes</p></div>
                                                                                                                                                                            <div class="field-wrap ta-icon"><i class="fas fa-comment-dots fi"></i>
                                                                                                                                                                            <textarea name="remark" class="field" rows="3" placeholder="Additional notes, ISP contact, account number, etc..." style="padding-top:.7rem;resize:vertical;"><?=htmlspecialchars($inet_edit['remark']??'')?></textarea>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            
                                                                                                                                                                            <button type="submit" class="btn-submit"><i class="fas fa-save"></i><?=$inet_is_edit?'Update Internet Record':'Save Internet Record'?></button>
                                                                                                                                                                            </form>
                                                                                                                                                                            </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                                                                                                                                                                            ...
                                                                                                                                                                            if(!endVal){box.textContent='â€”';box.style.color='var(--muted)';warn.style.display='none';return;}
                                                                                                                                                                            const today = new Date(); today.setHours(0,0,0,0);
                                                                                                                                                                            const end = new Date(endVal); end.setHours(0,0,0,0);
                                                                                                                                                                            const diff = Math.round((end-today)/86400000);
                                                                                                                                                                            if(diff<0){box.textContent='Expired ('+Math.abs(diff)+'d ago)';box.style.color='#b91c1c';warn.style.cssText='display:block;background:#fee2e2;color:#b91c1c;border:1px solid #fecaca;';warn.innerHTML='<i class="fas fa-times-circle"></i> This contract has expired!';}
                                                                                                                                                                            else if(diff<=30){box.textContent=diff+' days left';box.style.color='#c2410c';warn.style.cssText='display:block;background:#ffedd5;color:#c2410c;border:1px solid #fed7aa;';warn.innerHTML='<i class="fas fa-triangle-exclamation"></i> <b>'+diff+' days</b> remaining â€” please renew the contract!';}
                                                                                                                                                                            else{box.textContent=diff+' days left';box.style.color='#15803d';warn.style.display='none';}
                                                                                                                                                                            }
                                                                                                                                                                            document.getElementById('inet_end_date').addEventListener('change',calcDays);
                                                                                                                                                                            calcDays();
                                                                                                                                                                            
                                                                                                                                                                            // —— File Browse: Local Document → Auto-fill Document Link 
                                                                                                                                                                            ...
                                                                                                                                                                            // Fill document_local with filename
                                                                                                                                                                            document.getElementById('doc_local_field').value = fname;
                                                                                                                                                                            // Auto-generate document_link as a relative upload path
                                                                                                                                                                            ...
                                                                                                                                                                            // Allow typing in doc_local to clear the file selection indicator
                                                                                                                                                                            ...
                                                                                                                                                                            e.preventDefault();const form=this;const isEdit=form.querySelector('input[name="internet_id"]')!==null;
                                                                                                                                                                            fetch('save_internet.php',{method:'POST',body:new FormData(form)})
                                                                                                                                                                            .then(r=>{const ct=r.headers.get('content-type')||'';if(!ct.includes('json'))return r.text().then(t=>{throw new Error(t.substring(0,200));});return r.json();})
                                                                                                                                                                            .then(data=>{
                                                                                                                                                                            if(data.status==='saved'){Swal.fire({icon:'success',title:'Saved!',text:'Internet record has been saved.',confirmButtonColor:'#01244d',timer:2500,timerProgressBar:true});if(!isEdit)form.reset();}
                                                                                                                                                                            else if(data.status==='updated'){Swal.fire({icon:'success',title:'Updated!',text:'Internet record has been updated.',confirmButtonColor:'#01244d',timer:2500,timerProgressBar:true});}
